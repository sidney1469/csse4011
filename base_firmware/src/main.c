...
/* Stack areas for application threads */
...
int main(void)
{
    /* Initialise default beacon configuration before starting application threads */
    init_default_beacons();

    /* Start Bluetooth central thread */
