...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_FIRMWARE_MODULE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_CSSE4011_SDK_MODULE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_AUTO_PHY_CENTRAL_2M, 1);
